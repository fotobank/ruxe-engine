    ...
    switch ($_GET['step']) {
            ...
            echo '
                <center>
                    <div class="optionstable">
                        <div class="title">Установка Ruxe Engine: Шаг 1 из 5</div>
                        <div class="text">
        ...
        case "2":
            echo '
                <center>
                    <div class="optionstable">
                        <div class="title">Установка Ruxe Engine: Шаг 2 из 5</div>
                        <div class="text">
            ';
            $error = false;
...
';
                ...
                if (!$found) {
                    echo 'Основные файлы системы загружены на сервер.<br><br>';
                } else {
                    $iferror .= '
                            </table>
                        </center>
                ...
                if ($found) {
                    echo '
                        <center>
                            <form name="edit" method="post" action="?step=2&rand=' . rand(0, 9999) . '">
        ...
        case "3":
            echo '
                <center>
                    <div class="optionstable">
                        <div class="title">Установка Ruxe Engine: Шаг 3 из 5</div>
                        <div class="text">
            ';
            $error = false;
            if (!isset($_POST['rule1'])) {
            ...
            if (!$error) {
                ...
                if ($found) {
                    ...
                    echo '
                        <center>
                            <form name="edit" method="post" action="?step=3&rand=' . rand(0, 9999) . '">
                                <font color="red"><b>На данном шаге установки обнаружены ошибки. Пожалуйста, исправьте их и обновите страницу</b></font><br><br>
                                <input type="hidden" name="rule1" value="true">
                                <input type="submit" name="submit" value="Обновить страницу">
                            </form>
        ...
        case "4":
            echo '
                <center>
                    <div class="optionstable">
                        <div class="title">Установка Ruxe Engine: Шаг 4 из 5</div>
                        <div class="text">
            ';
            $error = false;
            if (!isset($_POST['rule1'])) {
            ...
            if (!$error) {
                ...
                if ($found) {
                    echo '
                        <center>
                            <form name="edit" method="post" action="?step=4&rand=' . rand(0, 9999) . '">';
                    ...
                    echo '      <font color="red"><b>На данном шаге установки обнаружены ошибки. Обратитесь к администратору сервера или внесите сами нужные изменения, если имеете достаточные привилегии.</b></font><br><br>';
                    echo '
                                <input type="hidden" name="rule1" value="true">
                                <input type="submit" name="submit" value="Обновить страницу">
                            </form>
        ...
        case "5":
            echo '
                <center>
                    <div class="optionstable">
                        <div class="title">Установка Ruxe Engine: Шаг 5 из 5</div>
                        <div class="text">
            ';
            $error = false;
            if (!isset($_POST['rule1'])) {
            ...
            if (!$error) {
                ...
                echo '
                    <h3>Установка главных параметров</h3><br>
                    <form name="edit" action="?step=6&rand=' . rand(0, 99999) . '" method="post">
                        ...
                        <input type="hidden" name="rule1" value="true">
                        <center><input type="submit" name="submit" value="Продолжить"></center>
                    </form>
                ';
            };
            echo '</div></div></center>';
        ...
        case "6":
            echo '
                <center>
                    <div class="optionstable">
                        <div class="title">Установка Ruxe Engine</div>
                        <div class="text">
            ';
            $error = false;
...
?>
<br><br>
<center><font style="color:#6B6B6B;">Powered by <a target="_blank" style="color:#6B6B6B;font-weight:bold;"
