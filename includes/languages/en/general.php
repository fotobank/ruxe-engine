...
$lcms['user_invalid'] = "In login and the password it is possible to use only letters of the English alphabet, number, <b>@</b>, <b>!</b> и <b>-</b>";
...
Don't forget to read, please, <a href=\"documentation\" target=\"_blank\">documentation</a>.<br><br>
...
$lcms['modifed_generals'] = 'Changes are found in includes/functions.general.php<br>Recover the specified file from <a href="http://engine.ruxesoft.net/download">the original distribution kit</a> the used version';
...
$lcms['pm_theme'] = "Theme: ";
$lcms['guest_not_write'] = "<br><br><center><a href=\"".$cms_site."/registration/\">Register</a> or enter into your account to leave the comment</center><br>";
...
$lcms['botdownload_message'] = "It is forbidden to robots to downloading files. If you consider it as an error, most likely - you not the robot so address in  <a href=\"http://engine.ruxesoft.net/feedback.html\">Technical support Ruxe Engine</a>.";
