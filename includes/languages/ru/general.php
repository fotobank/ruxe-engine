...
Не забудьте, пожалуйста, прочитать <a href=\"documentation\" target=\"_blank\">документацию</a>.<br><br>
...
$lcms['modifed_generals'] = 'Обнаружены изменения в includes/functions.general.php.<br>Восстановите указанный файл из <a href="http://engine.ruxesoft.net/download">оригинального дистрибутива</a> используемой версии.';
...
$lcms['botdownload_message'] = "Роботам запрещено качать файлы! Если вы считаете это ошибкой, то, скорее всего, вы не робот. Пожалуйста, обратитесь в <a href=\"http://engine.ruxesoft.net/feedback.html\">Техническую поддержку Ruxe Engine</a>.";
