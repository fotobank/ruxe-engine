...
<body>
        ...
        <!-- Команда для вывода текста "Сделано на Ruxe Engine" с указанием ссылки на официальный сайт (команда необязательная, но мы надеемся, что вы её будете использовать); местоположение данной команды может быть в любом месте страницы в пределах тегов <body></body>-->
        {CREDITS}
</body>
</html>
```
