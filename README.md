...
Усовершенствованная версия Счётчиков загрузок Ruxe Engine. 

- Серьёзно снижена вероятность обнуления и повышена производительность за счёт
разделения данных на несколько конфигурационных файлов;
- Для загрузки определяется не только адрес файла, но и зеркало;                                                         	
- Правка идентификатора;                                                          	
- Возможность обнуления счётчика.
