...
Примечание от Buranek: на lighttpd работает, но без ЧПУ
...
2. Скачайте стабильный релиз Ruxe Engine по адресу [ruxe-engine.ru/download](http://ruxe-engine.ru/download).
...
Полный путь до каталога выбранной темы оформления без / на конце. Например, **<?php here_urltheme(); ?>** = **http://ruxe-engine.ru/themes/re**.
...
В этом случае команда вернёт правильный путь до этой страницы с учётом опции ЧПУ. Например, **<?php here_urlsite('mypage'); ?>** = **http://site.ext/mypage** (ЧПУ активирован) или **http://site.ext/?viewpage=mypage** (ЧПУ деактивирован).
...
<?php
    /*
        ...
        $install - функция автоматически выполнится при активации дополнения
 		$uninstall - функция автоматически выполнится при деактивации дополнения
    */
